...
import com.ruthere.application.customlist.CustomList_Status;
...
public class ProfessorMain extends AppCompatActivity
    ...
    protected void onResume() {
        ...
        navigationView = (NavigationView) findViewById(R.id.nav_professor);
        headerView = navigationView.getHeaderView(0);
        TextView nameText = (TextView) headerView.findViewById(R.id.textView_nav_admin_name);
                                        ...
                                        for (DataSnapshot postSnapshot : dataSnapshot.getChildren()) {
                                            ...
                                            if (username.equals(users.getEmail())) {
                                                ...
                                                if (counter == 1 && counteremail == 0) {
                                                    SendMail sm = new SendMail(ProfessorMain.this, username, "Change Password", "Your password has changed. Your current password is " + input.getText().toString() + " -- Please use the given password on your next login. Thank you.");
                                                    sm.execute();
                                                    counteremail++;
                                                }
                                            }
    ...
    public void equate(Users user)
    {
        ...
        navigationView = (NavigationView) findViewById(R.id.nav_professor);
        headerView = navigationView.getHeaderView(0);
        TextView emailText = (TextView) headerView.findViewById(R.id.textView_nav_prof_email);
        TextView nameText = (TextView) headerView.findViewById(R.id.textView_nav_admin_name);
